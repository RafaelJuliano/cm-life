...
export default function Especialidades() {
    return (
        <section>
            ...
            <ItemEspecialidade id='ortopedia' titulo='Ortopedia' texto='A ortopedia é a especialidade médica que cuida da saúde relacionadas aos elementos do aparelho locomotor, como ossos, músculos, ligamentos e articulações.' imagem='public/assets/ortopedia.png'>
